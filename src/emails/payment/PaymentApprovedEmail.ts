    ...
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f5f5f5;">
        <tr>
                    ...
                    <tr>
                        <td style="padding: 40px 35px; background-color: #ffffff;">
                            ...
                            <p style="margin: 0 0 25px 0; font-size: 15px; line-height: 1.7; color: #555555;">
                                ¡Gracias por tu compra! Tu pago ha sido confirmado exitosamente y estamos procesando tu pedido. Te notificaremos cuando tu pedido sea enviado.
                            </p>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td style="padding: 15px 0 0 0; border-top: 2px solid #e5e5e5;">
                                                    <p style="margin: 0; font-size: 16px; font-weight: 600; color: #000000;">Total Pagado:</p>
                                                </td>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="padding: 3px 0;">
                                                    <p style="margin: 0; font-size: 13px; color: #166534;">Método de pago:</p>
                                                </td>
                                                <td style="padding: 3px 0; text-align: right;">
                                                    <p style="margin: 0; font-size: 13px; font-weight: 600; color: #166534;">${payment.paymentMethod === 'master' ? 'Mastercard' : payment.paymentMethod === 'visa' ? 'Visa' : payment.paymentMethod.charAt(0).toUpperCase() + payment.paymentMethod.slice(1)}</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 3px 0;">
                                                    <p style="margin: 0; font-size: 13px; color: #166534;">ID de transacción:</p>
                                                </td>
                                                <td style="padding: 3px 0; text-align: right;">
                                                    <p style="margin: 0; font-size: 13px; font-weight: 600; color: #166534;">${payment.mpPaymentId}</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 3px 0;">
                                                ...
                                                <td style="padding: 3px 0; text-align: right;">
                                                    <p style="margin: 0; font-size: 13px; font-weight: 600; color: #16a34a;">Aprobado</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td style="background-color: #f9f9f9; border-left: 4px solid #000000; padding: 15px 20px; border-radius: 6px;">
                                        ...
                                        <p style="margin: 0; font-size: 13px; line-height: 1.5; color: #666666;">
                                            Estamos preparando tu pedido con mucho cuidado. Recibirás un correo cuando tu pedido sea enviado con el número de seguimiento del courier.
                                        </p>
                                    </td>
                                </tr>
                            </table>
            ...
            const mailOptions = {
                ...
                subject: `📦🚚 Pago Exitoso - ${order.trackingNumber}`, 
                html: emailHTML
            }
