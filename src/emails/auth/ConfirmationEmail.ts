                    ...
                    <tr>
                        <td style="padding: 40px 35px; background-color: #ffffff;">
                            ...
                            <p style="margin: 0 0 25px 0; font-size: 15px; line-height: 1.7; color: #555555;">
                                Hemos recibido una solicitud para confirmar la cuenta de tu correo en Morango Joyas. Haz clic en el botón a continuación para activar tu cuenta y comenzar a explorar nuestra colección exclusiva.
                            </p>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="text-align: center; padding: 10px 0 25px;">
                                        <a href="${confirmationUrl}" style="display: inline-block; padding: 15px 45px; background-color: #000000; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 600; border-radius: 10px;">
                                            Confirmar Cuenta
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="margin: 0; font-size: 12px; word-break: break-all; color: #999999; background-color: #f5f5f5; padding: 12px; border-radius: 6px;">
                                <a href="${confirmationUrl}" style="color: #666666; text-decoration: none;">
                                    ${confirmationUrl}
                                </a>
                            </p>
                        </td>
